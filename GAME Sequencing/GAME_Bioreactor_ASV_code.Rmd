...
head(table_rel)
write.xlsx(table_rel, "ASV_Abundance.xlsx")
...
head(table1)
write.xlsx(table_rel, "ASV_sample_abundance")
write.xlsx(table1, "Shortform_Abundance_Table.xlsx")
```
